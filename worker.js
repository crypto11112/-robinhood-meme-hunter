 ...
 *
 * V80 goals:
 * - Fix V79 undefined/mismatched function names
 * - Preserve existing KV state key
 * - True live-first Robinhood Chain scanning
 * - Independent historical catch-up cursor
 ...
 *
 * Secrets:
 *   ALCHEMY_API_KEY      optional fallback
...
function processDiscoveryLogs(
  ...
  /*
   * First collect pool initialization.
   */
  for (
    const log of logs
  ) {
...
async function scan(env) {
  ...
  return {
    ...
    scanMode:
      "V80_TRUE_LIVE_FIRST_PERSISTENT_CATCHUP",
    ...
    architecture:
      "V80_TRUE_LIVE_FIRST_EARLY_LAUNCH_MULTI_SIGNAL_HUNTER",
...
async function telegramTest(
  ...
  const message =
`✅ <b>Robinhood Chain Meme Hunter V80</b>
